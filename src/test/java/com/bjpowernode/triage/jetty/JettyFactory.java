package com.bjpowernode.triage.jetty;
...
public class JettyFactory {
	...
	private static final String WINDOWS_WEBDEFAULT_PATH = "src/test/java/com/bjpowernode/triage/jetty/webdefault-windows.xml";
